...
class LinearTransformabilityHornClause(object):
    ...
    def generalize_intransformability(self, summaries_by_pred, bad_clauses):
        pass
...
class LinearPdr(ivy_infer_universal.UnivPdrElements):
    def __init__(self, preds, init_chc_lst, mid_chc_lst, end_chc_lst):
        ...
        self._initial_summary = {pred: ivy_logic_utils.true_clauses() for pred in self._preds}
        for init_chc in init_chc_lst:
            pass
